...
if [ ! -f "../../lib/release/lin-x86_64-gcc/libdhd.so.3" ]; then
    ln -rs ../../lib/release/lin-x86_64-gcc/libdhd.so.3.17.6 ../../lib/release/lin-x86_64-gcc/libdhd.so.3
fi
if [ ! -f "../../lib/release/lin-x86_64-gcc/libdrd.so.3" ]; then
    ln -rs ../../lib/release/lin-x86_64-gcc/libdrd.so.3.17.6 ../../lib/release/lin-x86_64-gcc/libdrd.so.3
fi
